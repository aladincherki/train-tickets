 ...
 * 
 * @Component public class SpringBatchJobLauncher {
 * 
 * private static final Logger LOGGER =
 * LoggerFactory.getLogger(SpringBatchJobLauncher.class);
 * 
 * private final Job job; private final JobLauncher jobLauncher;
 * 
 * @Autowired public SpringBatchJobLauncher(Job job, JobLauncher jobLauncher) {
 * super(); this.job = job; this.jobLauncher = jobLauncher; }
 * 
 * @Scheduled(cron = "0/10 * * * * *") public void runSpringBatchExampleJob()
 ...
 * 
 * private JobParameters newExecution() { Map<String, JobParameter> parameters =
 * new HashMap<>();
 * 
 * JobParameter parameter = new JobParameter(new Date(), null);
